 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.kcl.group32.units.units.impl.IntVarExpressionImpl#getVar <em>Var</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntVarExpressionImpl extends IntExpressionImpl implements IntVarExpression
{
  ...
  {
    return UnitsPackage.Literals.INT_VAR_EXPRESSION;
  }
    ...
    if (var != null && var.eIsProxy())
    {
      ...
      if (var != oldVar)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UnitsPackage.INT_VAR_EXPRESSION__VAR, oldVar, var));
      }
    }
    return var;
  }
  ...
  public void setVar(VariableDeclaration newVar)
  {
    ...
    var = newVar;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UnitsPackage.INT_VAR_EXPRESSION__VAR, oldVar, var));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case UnitsPackage.INT_VAR_EXPRESSION__VAR:
